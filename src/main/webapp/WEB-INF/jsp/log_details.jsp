	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			$(document).ready(function() {
			    ...
			    "sAjaxSource": "getLogListings.html",
			    "aoColumns": [
	                        ...
	                        "data":[
	                            {
	                                ...
	                                "children" :[
	                                            ...
	                                            {"data":"PROD1", "children":
	                                            	 [{"data":"BCS",  "metadata":{ "id":"103"}},
	                                                  {"data":"Client Statements", "metadata":{ "id":"104"}},
	                                                  {"data":"Mailbox-411","metadata":{ "id":"105"}},
	                                                  {"data":"System Out", "metadata":{ "id":"109"}}]
		                                                 },
	                                             {"data":"PROD2", "children":
	                                            	 [{"data":"BCS",  "metadata":{ "id":"106"}},
	                                                  {"data":"Client Statements", "metadata":{ "id":"107"}},
	                                                  {"data":"Mailbox-411","metadata":{ "id":"108"}},
	                                                  {"data":"System Out", "metadata":{ "id":"110"}}] 
	                                                 }
	                                            ]
	                            },
	                            {
	                                ...
	                                "children" :[
		                                            ...
		                                            {"data":"PROD1", "children":
		                                            	 [{"data":"PFP",  "metadata":{ "id":"203"}},
		                                                  {"data":"Client Statements", "metadata":{ "id":"204"}},
		                                                  {"data":"Contact","metadata":{ "id":"205"}}] 
			                                                 },
		                                             {"data":"PROD2", "children":
		                                            	 [{"data":"PFP",  "metadata":{ "id":"206"}},
		                                                  {"data":"Client Statements", "metadata":{ "id":"207"}},
		                                                  {"data":"Contact","metadata":{ "id":"208"}}] 
		                                                 }
		                                            ]
	                            },
	                            {
	                                ...
	                                "children" :[
		                                            {"data":"PROD", "children":
		                                            	 [{"data":"External",  "metadata":{ "id":"300"}},
		                                                  ...
		                                                  {"data":"I-Shared","metadata":{ "id":"302"}},
		                                                  {"data":"E-Shared","metadata":{ "id":"303"}} ] 
		                                                 },
		                                            {"data":"PROD1", "children":
		                                            	 [{"data":"External",  "metadata":{ "id":"304"}},
		                                                  {"data":"Internal", "metadata":{ "id":"305"}},
		                                                  {"data":"I-Shared","metadata":{ "id":"306"}},
		                                                  {"data":"E-Shared","metadata":{ "id":"307"}} ]  
			                                             },
				                                      {"data":"PROD1", "children":
				                                            	 [{"data":"External",  "metadata":{ "id":"308"}},
				                                                  {"data":"Internal", "metadata":{ "id":"309"}},
				                                                  {"data":"I-Shared","metadata":{ "id":"310"}},
				                                                  {"data":"E-Shared","metadata":{ "id":"311"}} ]  
					                                        }
		                                            ]
	                            },
	                            {
	                                ...
	                                "children" :[
		                                {"data":"PROD", "children":
                                        	 [{"data":"WAS",  "metadata":{ "id":"400"}},
                                              {"data":"Calc", "metadata":{ "id":"401"}}
                                             ]
		                                }
	                                ]
	                            }
