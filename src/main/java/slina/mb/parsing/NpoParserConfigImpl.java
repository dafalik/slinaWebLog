 ...
 *
 */
public class NpoParserConfigImpl  implements ParserConfig {
	
	
	private static final Logger LOGGER = Logger.getLogger(NpoParserConfigImpl.class);

	protected  String regex;
	protected LogLevelMap logLevelLookup ;
	protected Pattern pattern;
	protected int id, year, month, day, hour,minute, seconds, miliseconds, logClass, logLevel, logMessage1, logMessage2;
	

	
	public NpoParserConfigImpl(String regex, LogLevelMap logLevelLookup) {
		this.regex = regex;
	...
	public LogEvent createLogEvent(Matcher matcher) {
		...
		LogEvent le = new LogEventImpl(
				...
				matcher.group(this.logMessage1).trim()+" "+matcher.group(this.logMessage2).trim()
				);
	...
	public void setLogMessage1(int logMessage1) {
		this.logMessage1 = logMessage1;
	}



	public void setLogMessage2(int logMessage2) {
