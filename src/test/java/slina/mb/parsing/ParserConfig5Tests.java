...
public class ParserConfig5Tests {
	...
	String[] samples = { 
			"[2012-10-15 08:32:03,     0] INFO[initDefinitionsFactory](TilesPlugin:236) - Tiles definition factory loaded for module",
			"at java.net.SocketOutputStream.socketWrite0(Native Method)",
			"[2012-10-15 08:32:04,  1203] INFO[buildSettings](SettingsFactory:213) - Query cache: disabled",
			"[2012-11-02 09:00:15,   422] INFO[<clinit>](Environment:555) - using JDK 1.4 java.sql.Timestamp handling",
			"[2012-10-15 08:32:04,  1437] INFO[addInstance](SessionFactoryObjectFactory:82) - Not binding factory to JNDI, no JNDI name configured"
			  };
	 ...
	 String[] singleSamples = {
		...
		public void testString() {
			...
			List<String> stringList = Arrays.asList(singleSamples);
			 ...
			 List<LogEvent> resultaArray = stdLogParser.createLogEvents(5, stringList);
